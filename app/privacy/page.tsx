...
const company = siteConfig.company?.name ?? "this business";
const email = siteConfig.contact?.email ?? "privacy@example.com";
const jurisdiction = siteConfig.contact?.address ?? "our operating region";
